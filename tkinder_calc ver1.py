...
def bequal():
    ...
    strlen=len(str_txt)
    operator=['+','-','*','/']
    if str_txt[0]=='+' or str_txt[0]=='-' or str_txt[0]=='*' or str_txt[0]=='/':
        ...
        for i in range(1,strlen,1):
            j=i+1
            while i<strlen:
                if str_txt[i] in operator and str_txt[j] in operator:
                    result="Invalid expression!!!"
                    do_fun(result) 
                else:
                    print(str_txt[i],str_txt[i+1])
        ...
        temp1=[]
        sub_string="" 
        plus_no=str_txt.find('+')
        minus_no=str_txt.find('-')
        mul_no=str_txt.find('*')
        div_no=str_txt.find('/')        
                
        #separating operators and operands in to two list
        for item in str_txt:
            if item.isdigit():
...
# C-reate two input fields and a button 
